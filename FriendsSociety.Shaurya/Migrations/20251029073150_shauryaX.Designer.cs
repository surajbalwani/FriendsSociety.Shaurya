...
namespace FriendsSociety.Shaurya.Migrations
{
    ...
    [Migration("20251029073150_shauryaX")]
    partial class shauryaX
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FriendsSociety.Shaurya.Entities.Game", b =>
                {
                    ...
                    b.Property<int>("DisabilityTypeCode")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FriendsSociety.Shaurya.Entities.Participant", b =>
                {
            ...
            modelBuilder.Entity("FriendsSociety.Shaurya.Entities.ParticipantGame", b =>
                {
                    b.Property<int>("ParticipantGameID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ParticipantGameID"));
            ...
            modelBuilder.Entity("FriendsSociety.Shaurya.Entities.Volunteer", b =>
                {
            ...
            modelBuilder.Entity("FriendsSociety.Shaurya.Entities.ParticipantGame", b =>
                {
                    b.HasOne("FriendsSociety.Shaurya.Entities.Game", "Game")
                        .WithMany()
                        .HasForeignKey("GameID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FriendsSociety.Shaurya.Entities.Participant", "Participant")
                        .WithMany()
            ...
            modelBuilder.Entity("FriendsSociety.Shaurya.Entities.TeamAssignment", b =>
                {
                    ...
                    b.HasOne("FriendsSociety.Shaurya.Entities.Volunteer", "Leader")
                        .WithMany()
