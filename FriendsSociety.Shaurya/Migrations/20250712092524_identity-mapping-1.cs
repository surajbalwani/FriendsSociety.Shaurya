...
{
    /// <inheritdoc />
    public partial class identitymapping1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityID = table.Column<int>(type: "int", nullable: false),
                    AbilityTypeID = table.Column<int>(type: "int", nullable: false),
                    ExclusionType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AbilityTypes_AbilityTypeID",
                        column: x => x.AbilityTypeID,
                        principalTable: "AbilityTypes",
                        principalColumn: "AbilityTypeID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AbilityTypeID",
                table: "AspNetUsers",
                column: "AbilityTypeID");
